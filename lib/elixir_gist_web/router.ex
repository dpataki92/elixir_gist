defmodule ElixirGistWeb.Router do
  ...
  import ElixirGistWeb.UsersAuth
  ...
  scope "/", ElixirGistWeb do
    ...
    live_session :redirect_if_users_is_authenticated,
      on_mount: [{ElixirGistWeb.UsersAuth, :redirect_if_users_is_authenticated}] do
  ...
  scope "/", ElixirGistWeb do
    ...
    live_session :require_authenticated_users,
      on_mount: [{ElixirGistWeb.UsersAuth, :ensure_authenticated}] do
  ...
  scope "/", ElixirGistWeb do
    ...
    live_session :current_users,
      on_mount: [{ElixirGistWeb.UsersAuth, :mount_current_users}] do
