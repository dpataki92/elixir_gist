defmodule ElixirGistWeb.UsersAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_elixir_gist_web_users_remember_me"
  ...
  the current_users:
      ...
      defmodule ElixirGistWeb.PageLive do
        ...
        on_mount {ElixirGistWeb.UsersAuth, :mount_current_users}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{ElixirGistWeb.UsersAuth, :ensure_authenticated}] do
